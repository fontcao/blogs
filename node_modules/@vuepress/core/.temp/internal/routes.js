...
import GlobalLayout from "/Users/caocan/Desktop/project-demo/blods/blogs/node_modules/@vuepress/core/lib/client/components/GlobalLayout.vue"
...
export const routes = [
  {
    ...
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-dc8c1344").then(next)
    },
  },
  {
    path: "/index.html",
  ...
  },
  {
    ...
    component: GlobalLayout,
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-9357a246").then(next)
    },
  },
  {
    name: "v-08b2e57d",
    ...
    component: GlobalLayout,
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-08b2e57d").then(next)
    },
  },
  {
    name: "v-b1564aac",
